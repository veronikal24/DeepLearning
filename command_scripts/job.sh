...
#BSUB -o logs/output_%J.log                # Output log file (including job ID %J)
#BSUB -e logs/error_%J.err                 # Error log file
...
cd DeepLearning
# executes the script
python tptrans.py --k 2000 --epochs 500 --ds_window_total 600 --ds_window_pred 240 
