...
#BSUB -J TPInform                  # Job name
#BSUB -o logs/output_tpi_%J.log                # Output log file (including job ID %J)
#BSUB -e logs/error_tpi_%J.err                 # Error log file
...
#BSUB -W 06:00                        # Time limit (5 hours)
...
cd DeepLearning-1
# executes the script
python tpinform.py --k 1000 --epochs 300 --ds_window_total 420 --ds_window_pred 120
